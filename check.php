...
<div style="width:100%;background:#FFCC99;text-align:center;"><h3><?php echo $lang_check_confirm;?>:<?php echo $id;?>!</h3></div>
<div><table align="center">
<tr>
	<td><form action="index.php?link=check" method="POST"><input type="submit" value="<?php echo $lang_ok;?>" /><input type="hidden" value="3" name="hidd" /><input type="hidden" name="id" value="<?php echo $id;?>" /></form></td>
...
<?php
	...
	if ($_POST['hidd']=='3'){
	$updaterow=$GLOBALS['conn']->query("UPDATE pcservice SET checked=1 WHERE id='$id'");
		if (!$updaterow){die($GLOBALS['conn']->error);}
?>
	
	<div style="width:100%;background:#CCFFCC">
<div style="width:100%;text-align:center;"><h4><?php echo $lang_check_succ;?></h4></div>
<div><table align="center">
<tr>
